...
<div class="main">
    <!--hero section start-->
    <section class="hero-equal-height pt-120 pb-100" style="background: url('img/hero-bg.jpg')no-repeat bottom center / cover">
        <div class="hero-bottom-shape-two" style="background: url('img/hero-bottom-shape-2.svg')no-repeat bottom center"></div>
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-12 col-lg-7">
                    <div class="hero-slider-content text-white z-index position-relative py-5">
                        <h1 class="text-white">Protective Steps Against The <span>(COVID-19)</span></h1>
                        <p class="lead">Holisticly procrastinate mission-critical convergence with reliable customer service. Assertively underwhelm idea-sharing for impactful solutions. Know how you'll protect yourself and stay safe</p>

                        <div class="action-btns mt-3">
                            <a href="#" class="btn accent-solid-btn mr-3">How to Protect <i class="fas fa-shield-alt pl-3"></i></a>
                            <a href="https://www.youtube.com/watch?v=i0ZabxXmH4Y" class="popup-youtube circle-btn"><i class="fas fa-play"></i> </a> <span class="pl-2">About COVID-19</span>
                        </div>
                        <div class="counter-case">
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="counter-item d-flex align-items-center">
                                        <div class="single-counter-item">
                                            <span class="h4">143,870</span>
                                            <h6 class="text-white">Recovered Cases</h6>
                                        </div>
                                        <span class="color-6 ml-2 p-2 rounded-circle">
                                            <i class="fas fa-arrow-up icon-sm"></i>
                                        </span>
                                ...
                                <div class="col-6 col-sm-4">
                                    <div class="counter-item d-flex align-items-center">
                                        <div class="single-counter-item">
                                            <span class="h4">31,191</span>
                                            <h6 class="text-white">Deaths</h6>
                                        </div>
                                        <span class="color-6 ml-2 p-2 rounded-circle">
                                            <i class="fas fa-arrow-up icon-sm"></i>
                                        </span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-3">
                    <div class="prevention-block text-center">
                        <img src="img/prevention-1.svg" width="120" alt="prevention">
                        <h5>Wash Your Hands</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="prevention-block text-center">
                        <img src="img/prevention-2.svg" width="120" alt="prevention">
                        <h5>Use Face Mask</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="prevention-block text-center">
                        <img src="img/prevention-3.svg" width="120" alt="prevention">
                        <h5>Go to The Doctor</h5>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="prevention-block text-center">
                        <img src="img/prevention-4.svg" width="120" alt="prevention">
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-12 col-lg-6">
                    <div class="about-content-wrap">
                        ...
                        <ul class="check-list-info">
                            ...
                            <li><strong>Distance between yourself and other people</strong> – if COVID-19 is spreading in your community. This is especially important for people who are at higher risk of getting very sick.</li>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="rotate-img-wrap">
                        <img src="img/virus-1.png" alt="video" class="img-fluid position-relative rotateme">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="services-section ptb-100 gray-light-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center mb-5">
                        <h2>Symptoms of Corona Virus</h2>
                        <p class="lead">Efficiently aggregate end-to-end core competencies without maintainable ideas. Dynamically
                            foster tactical solutions without enabled value.</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-1.svg" alt="consulting" width="80" class="mb-3">
                        <h5>Cough</h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-2.svg" alt="consulting" width="80" class="mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-3.svg" alt="consulting" width="80" class="mb-3">
                        <h5>Confusion</h5>
                        <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                            partnerships.</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-4.svg" alt="consulting" width="80" class="mb-3">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-5.svg" alt="consulting" width="80" class="mb-3">
                        <h5>Hot Fever</h5>
                        <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                            partnerships.</p>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="services-single animated-hover text-center p-5 my-md-3 my-lg-3 my-sm-0 shadow-sm white-bg rounded">
                        <img src="img/symptoms-icon-6.svg" alt="consulting" width="80" class="mb-3">
                        <h5>Sore Throat</h5>
                        <p class="mb-0">Progressively empower business "outside the box" thinking with resource-leveling
                            partnerships.</p>
                    </div>
    ...
    <section class="call-to-action gradient-overlay" style="background: url('img/header-bg-1.jpg')no-repeat center center / cover fixed">
        <div class="container">
            <div class="row align-items-center">
    ...
    <section class="start-prevention ptb-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        <h2>What Should You Do For COVID-19</h2>
            ...
            <div class="row start-website-box">
                <div class="col-lg-6 col-12 pr-lg-0">
                    <div class="left-box gray-light-bg">
                        <div class="d-flex align-items-center mb-4">
                            <span class="fas fa-thumbs-up icon-sm text-white primary-bg p-2 rounded mr-3"></span>
                            <h5 class="mb-0">Things We Should Do</h5>
                        </div>
                        <ul>
                            <li class="d-flex align-items-start">
                                <img src="img/prevention-1.svg" width="50" class="mr-3" alt="prevention">
                                <div class="prevention-info">
                                    <strong>Wash your hands sanitizer</strong>
                                    <p>Regularly and thoroughly clean your hands</p>
                                </div>
                            </li>
                            <li class="d-flex align-items-start">
                                <img src="img/prevention-2.svg" width="50" class="mr-3" alt="prevention">
                                <div class="prevention-info">
                                    <strong>Ware a face mask outside</strong>
                                    <p>You should wear a face mask when outside</p>
                                </div>
                            </li>
                            <li class="d-flex align-items-start">
                                <img src="img/prevention-3.svg" width="50" class="mr-3" alt="prevention">
                                <div class="prevention-info">
                                    <strong>Cover your cough tissue paper</strong>
                                    <p>Immediately wash your hands with soap</p>
                                </div>
                            </li>
                            <li class="d-flex align-items-start">
                                <img src="img/prevention-4.svg" width="50" class="mr-3" alt="prevention">
                                <div class="prevention-info">
                                    <strong>Call for ambulance if emergency</strong>
                                    <p>For medical emergencies, call 911 emergency</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-12 pl-lg-0">
                    <div class="right-box primary-bg">
                        <div class="d-flex align-items-center mb-4">
                            <span class="fas fa-thumbs-down icon-sm color-primary white-bg p-2 rounded mr-3"></span>
                            <h5 class="mb-0 text-white">Things We Shouldn't Do </h5>
                        </div>
                        <ul>
                            <li class="d-flex align-items-start">
    ...
    <!--wash hand section start-->
    <section class="wash-hand-section ptb-100 primary-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        <h2 class="text-white">How to Wash Your Hands</h2>
                        <p class="lead">Get Immediate Activation or Express Transfer service free of charge.
                            Enthusiastically enhance plug-and-play testing procedures and cross.</p>
                    </div>
                </div>
            ...
            <div class="row" style="counter-reset: number">
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        ...
                        <h5 class="text-white">Wet Hands</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h2.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Apply Shop</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h3.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Rub Hands Palm to Palm</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h4.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Lather The Back of Both Hands</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h5.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Scrub Between Your Fingers</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h6.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Rub The Back of Fingers on The Opposing Palm</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h7.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Clean Thumbs</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h8.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Wash Fingernails And Fingertips</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h9.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Rinse Hands</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h10.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Dry with a Single Use Towel</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h11.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Use The Towel to Turn off The Faucet</h5>
                    </div>
                </div>
                <div class="col-sm-4 col-md-4 col-lg-3">
                    <div class="wahs-hand-single text-center p-4 py-sm-0 py-md-4 py-lg-4">
                        <img src="img/h12.svg" alt="wash hand" width="150" class="img-fluid">
                        <h5 class="text-white">Your Hands Are Clean</h5>
                    </div>
                </div>
            </div>
        </div>
    </section>
    <!--wash hand section end-->

    <!--live map update section start-->
    <section class="map-update ptb-100">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-9 col-lg-8">
                    <div class="section-heading text-center mb-5">
                        <h2>Corona Virus (COVID-19) Live Reports</h2>
                        <p class="lead">The most common symptoms of COVID-19 and dry cough. Some patients may have aches and pains, nasal congestion, runny nose, sore throat or diarrhea.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <!--live map update section end-->

    <!--products section start-->
    <section class="product-section ptb-100 gray-light-bg">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="section-heading text-center mb-4">
                        <h2>Corona Virus Safety Products</h2>
            ...
            <div class="product-wrap pt-4">
                <div class="product-carousel owl-carousel owl-theme dot-indicator">
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            ...
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">Hand Rub</h4>
                                <h5 class="product-price">
                                    <del>$79.00</del>
                                    <span>$60.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            <img src="img/product-2.jpg" class="img-fluid" alt="product"/>
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">Hand Sanitizer</h4>
                                <h5 class="product-price">
                                    <del>$89.00</del>
                                    <span>$65.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                    ...
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            <img src="img/product-3.jpg" class="img-fluid" alt="product"/>
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">N95 Mask</h4>
                                <h5 class="product-price">
                                    <del>$59.00</del>
                                    <span>$35.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                    ...
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            <img src="img/product-4.jpg" class="img-fluid" alt="product"/>
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">ICU Ventilator</h4>
                                <h5 class="product-price">
                                    <del>$170.00</del>
                                    <span>$140.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                    ...
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            <img src="img/product-5.jpg" class="img-fluid" alt="product"/>
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">ICU Bed</h4>
                                <h5 class="product-price">
                                    <del>$99.00</del>
                                    <span>$79.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                    ...
                    <div class="item">
                        <div class="single-product rounded gray-light-bg">
                            <img src="img/product-6.jpg" class="img-fluid" alt="product"/>
                            <div class="product-info text-center py-4 px-3">
                                <h4 class="mb-1">Portable Parameters Monitor</h4>
                                <h5 class="product-price">
                                    <del>$179.00</del>
                                    <span>$160.00</span></h5>
                                <a href="#" class="btn cart-btn">Buy Now <i class="fas fa-shopping-cart pl-2"></i></a>
                ...
                <div class="col-md-4">
                    <div class="single-blog-card card border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="detail-link">Read more <span class="fa-solid fa-arrow-right"></span></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                        ...
                        <div class="card text-center border-0">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-inline pt-2 social">
                                    ...
                                    <li class="list-inline-item"><a href="" target="_blank"><span
                                            class="fa-brands fa-dribbble"></span></a></li>
                                </ul>
                            </div>
                        </div>
    ...
    <section class="appointment-section ptb-100 gray-light-bg">
        <div class="container">
                ...
                <div class="col-lg-5 align-self-center">
                    <div class="appointment-form-wrap rounded border">
                        <ul class="nav nav-tabs appointment-tab" role="tablist">
                            ...
                            aria-controls="two" role="tab" data-toggle="tab"
                             href="#two" aria-selected="false">Make Appointment</a>
                            </li>
                        </ul>
